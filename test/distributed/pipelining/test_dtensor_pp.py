...
8. End-to-end pipeline execution (parameterized)
"""
...
class TestStaticMetadataInference(DTensorPPTestBase):
    ...
    def test_static_metadata_inference(self):
        ...
        self.assertIsNotNone(stage._inputs_dtensor_meta[0])
        ...
        self.assertIsNotNone(stage._outputs_dtensor_meta[0])
        ...
        self.assertIsNotNone(stage._outputs_grad_dtensor_meta)
        self.assertEqual(len(stage._outputs_grad_dtensor_meta), 1)
        self.assertIsNotNone(stage._outputs_grad_dtensor_meta[0])
        ...
        self.assertIsNotNone(stage._inputs_grad_dtensor_meta)
        self.assertEqual(len(stage._inputs_grad_dtensor_meta), 1)
        self.assertIsNotNone(stage._inputs_grad_dtensor_meta[0])
...
# =============================================================================
# Test 8: End-to-End Pipeline (Parameterized - Existing)
# =============================================================================
